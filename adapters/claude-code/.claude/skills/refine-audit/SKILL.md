...
description: |
  ...
  dependency risk, and adherence to standards. Use with: /refine-audit
---
...
```
/refine-audit review the authentication module for security issues
/refine-audit audit all dependencies for known vulnerabilities
/refine-audit check the codebase against OWASP Top 10
```
...
After completing the base protocol steps, apply the audit profile from `promptforge/core/profiles/audit.md` (if available) or the following audit-specific analysis:
